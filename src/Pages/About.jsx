					...
					<Col xs="6">
						<div className="innerContent">
							...
							<p className="para">
								...
								clearing out your storage area, BroadcastStore.co can assist you
			...
			<div className="abt-flexdiv">
				<div className="row-1">
					<div className="col-1">
						...
						<p className="para">
							BroadcastStore.co develops workflow solutions for large-scale
						...
						<p className="para">
							Entrust BroadcastStore.co to preserve your media for decades to
							come.
						</p>
						<p className="para">
				...
				<div className="row-2">
					<div className="col-1">
						<div>
							...
							<p className="para">
								Clients have always looked to BroadcastStore.co to provide them
								with guidance and access to the equipment to meet their specific
								shooting needs.
							</p>
							<p className="para">
						...
						<div>
							...
							<p className="para">
								If we don’t have it we can find it. Broadcaststore.co has built
								a pervasive network to assist in the sourcing of hard to find or
								unique items.
							</p>
						</div>
						<div>
