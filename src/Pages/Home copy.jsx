...
const Home = () => {
  ...
  const [title, setTitle] = useState("The BroadCast Store - Buy Professional Equipment for Video Production");
  const [description, setDescription] = useState("Broadcast Store provides a wide selection of professional audiovisual equipment at competitive prices, allowing customers to get top-notch service department.");
                ...
                <Grid item xs={5}>
                  <Grid id="inner-card" className="yellow">
                    <Grid container spacing={2}>
                      <Grid item xs={5}>
                        <Grid className="content">
                          <Typography variant="h2">iPad Pro
                            Supercharged by</Typography>
                        </Grid>
                      </Grid>
                      <Grid item xs={7}>
                        <Grid className="content">
