...
const Navbarmenu = () => {
  ...
  const handleCategorySelect = (category) => {
    axios
      .get(`https://thebroadcaststore.co/admins/api/products/category/${category.id}`)
      .then((response) => {
        ...
        <Navbar expand="lg">
          <Container fluid>
            ...
            <Navbar.Collapse id="navbarScroll">
              <Nav className="menubar" style={{ maxHeight: '100px' }} navbarScroll>
                <NavDropdown title="Product Categories" id="navbarScrollingDropdown">
                  <NavDropdown.Item className='dropdown-hd'>Categories</NavDropdown.Item>
              ...
              <Link to="/top-frame-synchronizer-converter">Frame Synchronizer/Converter</Link>
              <Link to="/professional-video-i-o-with-tb3">Professional Video I/O with TB3</Link>
              <Link to="/top-ntsc-signal-generator">NTSC Signal Generator</Link>
              ...
              <Link to="/top-hd-cam-editing-recorder">HD CAM Editing recorder </Link>
              ...
              <Link to="/quad-broadcast">2" Quad broadcast Editor and Player</Link>
                </NavDropdown>
      ...
      {selectedCategory && !selectedProduct && (
        <Container>
          <div className="abtcontent">
            <h1 className="heading" data-aos="fade-up">{selectedCategory.title}</h1>
          </div>
        </Container>
      )}
                      ...
                      <Grid className="ftrd-slide">
                        <Grid className="ftrd-slide-blk">
                          ...
                          <Grid className="pro-disp">
                            ...
                            <p className="body">{product.short_desc}</p> {/* Render HTML content */}
                      <Button className="theme-btn">
                      <Link
                      to={`/${product.slug}`}
    ...
    <div className="headcontent">
      ...
      <Col xs="12">
          <div className="innerContent" data-aos="fade-right" >
            ...
            <p className="para" dangerouslySetInnerHTML={{ __html: selectedProduct.long_desc }}></p>   </div>
        </Col>
      </Row>
    </div>
  </Container>
